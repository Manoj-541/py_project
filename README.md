...
Extract all unique symptoms from dataset

Compare selected symptoms with each disease’s symptom list

Count the number of matches

Return the disease with the highest similarity score
